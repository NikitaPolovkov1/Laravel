                                    ...
                                    <div class="card">
                                        <div class="card-header pb-0">
                                            <div class="d-flex flex-row justify-content-between">
                                                ...
                                                <a href="/admin/addhouse" class="btn btn-primary text-white">
                                                    Добавить дом
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table align-items-center mb-0">
                                                    ...
                                                    @foreach($houses as $house)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p class="text-xs font-weight-bold mb-0">{{$house->name}}</p>
                                                            </td>
                                                            <td class="align-middle text-center text-sm">
                                                                <span class="badge badge-sm bg-gradient-success">{{$house->price_at_day}} BYN</span>
                                                            </td>
