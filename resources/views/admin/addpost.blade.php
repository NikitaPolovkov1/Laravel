        ...
        <div class="container mt-5">
            ...
            <form method="POST" action="{{ route('admin.storepost') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="post_img" name="post_img" readonly>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="post_sub_title" name="post_sub_title" required>
                </div>
                <div class="form-group">
